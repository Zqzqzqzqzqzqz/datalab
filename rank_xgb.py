...
def train_xgb(feature_pkl, mode='valid', n_splits=5):
    ...
    if mode == 'valid':
        ...
        save_path = '../user_data/data/online/xgb_preds.pkl'
        res_df.to_pickle(save_path)
        logger.info(f"Saved XGBoost predictions to {save_path}")
...
if __name__ == "__main__":
    ...
    train_xgb(FEAT_PKL, mode=args.mode)
