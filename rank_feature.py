...
def generate_features(recall_pkl, click_pkl, query_pkl, articles_df, mode='valid'):
    ...
    sample_df['words_count'] = sample_df['words_count'].fillna(0)
    
    # Cleanup
    del click_df, query_df
    gc.collect()
...
if __name__ == "__main__":
    ...
    feat_df = generate_features(RECALL_PKL, CLICK_PKL, QUERY_PKL, art_df, mode=args.mode)
